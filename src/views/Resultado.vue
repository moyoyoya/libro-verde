...
<form class="box">
  <div class="field">
    <h5 class="title is-4">Precios de venta <Icon icon="mdi:shield-home-outline" /></h5>
    <div class="seperator">
  <h5><span></span></h5>
</div>
  <div class="field">
...
<div class="column"></div>
  ...
  <div class="field">
    <h5 class="title is-4">Precios de renta <Icon icon="mdi:shield-key-outline" /></h5>
...
<form class="box">
  <div class="tile is-ancestor">
    ...
    <div class="columns is-desktop is-flex is-half is-hidden-touch ">
      ...
      <div class="column ">
        <h5 class="title is-3 has-text-grey">2.7</h5>
      </div>
      <div class="column ">
